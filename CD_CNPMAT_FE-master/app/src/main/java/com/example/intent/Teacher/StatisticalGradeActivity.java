...
public class StatisticalGradeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_statistical_grade);
        ...
        studentNormalAdapter = new StudentNormalAdapter(studentList, student -> {
            Intent intent = new Intent(StatisticalGradeActivity.this, StatisticalGradeDetailActivity.class);
                ...
                .enqueue(new Callback<ApiResponse<List<DataStudent>>>() {
                    ...
                    public void onResponse(Call<ApiResponse<List<DataStudent>>> call, Response<ApiResponse<List<DataStudent>>> response) {
                        if (response.isSuccessful() && response.body() != null && response.body().isSuccess()) {
                            ...
                            Toast.makeText(StatisticalGradeActivity.this,
                    ...
                    public void onFailure(Call<ApiResponse<List<DataStudent>>> call, Throwable t) {
                        Toast.makeText(StatisticalGradeActivity.this, "Gọi API thất bại: " + t.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
